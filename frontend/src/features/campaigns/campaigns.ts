// Verbatim marketing-copy data ported from web/lib/campaigns.ts (long strings are content).
...
export const PERSONA_CAMPAIGNS: PersonaCampaign[] = [
  {
    ...
    priority: "high",
    targetingSignal:
      "Engraving, gift wrap, delivery deadline, birthday, wedding, Father's Day, and personalisation questions.",
    opportunity:
      "Turn gift intent into a premium conversion path with engraving, packaging, and occasion-led deadlines.",
    angles: [
      {
        name: "Personalized caseback story",
        newsletterSubject: "Make the caseback mean something",
        newsletterPreview:
          "Engraving turns a Boldr watch into a keepsake for the person who is hard to shop for.",
        newsletterBody:
      ...
      },
      {
        ...
        newsletterPreview:
          "A clean engraving path, gift wrap, and clear delivery timing for high-intent gifters.",
        newsletterBody:
  ...
  },
  {
    ...
    priority: "high",
    targetingSignal:
      "BPA-free, nickel-free, hypoallergenic, allergy, sensitive skin, kids, dye safety, and certification questions.",
    opportunity:
      "Build trust with safety proof, material certifications, and clear strap-composition claims.",
    angles: [
      {
        name: "Hypoallergenic strap reassurance",
        newsletterSubject: "A strap built for sensitive skin",
        newsletterPreview:
          "Hypoallergenic materials, BPA-free silicone, and nickel-conscious hardware for everyday confidence.",
        newsletterBody:
      ...
      },
      {
        ...
        newsletterPreview:
          "A quick guide to strap materials for parents, active users, and sensitive-skin buyers.",
        newsletterBody:
  ...
  },
  {
    ...
    priority: "medium",
    targetingSignal:
      "Titanium grade, movements, lug width, NATO straps, sapphire, accuracy, servicing, limited editions, and resale questions.",
    ...
    angles: [
      {
        ...
        newsletterPreview:
          "Titanium, sapphire, movement accuracy, and strap compatibility in one technical guide.",
        newsletterBody:
  ...
  },
  {
    ...
    priority: "high",
    targetingSignal:
      "Outdoor, swimming, diving, trail running, climbing, altitude, shock resistance, rugged use, sizing, fit, and delivery-readiness questions.",
    opportunity:
      "Position Boldr as a rugged daily companion through use-case guides and fit confidence content.",
    angles: [
      {
  ...
  },
  {
    ...
    priority: "medium",
    targetingSignal:
      "Vegan materials, recycling, strap take-back, carbon-neutral shipping, ethical sourcing, and responsible packaging questions.",
    opportunity:
      "Create honest sustainability content that explains current capabilities and turns repeated gaps into roadmap signals.",
    angles: [
      {
        name: "Responsible materials roadmap",
        newsletterSubject: "What responsible watch ownership can look like",
        newsletterPreview:
          "Recycling, strap take-back interest, packaging questions, and where Boldr is focusing next.",
        newsletterBody:
      ...
      },
      {
        ...
        newsletterPreview:
          "A clear answer for buyers comparing recyclable packaging and carbon-conscious shipping.",
        newsletterBody:
